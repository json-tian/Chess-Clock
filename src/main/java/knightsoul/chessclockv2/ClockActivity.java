...
public class ClockActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Multiplied by 1000 because information is sent in seconds
        int num1 = getIntent().getExtras().getInt("tv_player1initial");
        p1Time = num1 * 1000;
        original1 = p1Time;

        int num2 = getIntent().getExtras().getInt("tv_player2initial");
        p2Time = num2 * 1000;
        original2 = p2Time;

        int num3 = getIntent().getExtras().getInt("tv_player1increment");
        increment1 = num3 * 1000;

        int num4 = getIntent().getExtras().getInt("tv_player2increment");
    ...
    public String updateText(long milliseconds) {
        if (milliseconds >= 3600000 && milliseconds < 86400000) {   //Greater than 1 hour and less than 24
